...
if __name__ == '__main__':
    ...
    <vertical>
        <button callback="newmaze">Reset Maze</button>
        <button callback="up">Up</button>
        <horizontal>
        <button callback="left">Left</button>
        <button callback="down">Down</button>
        <button callback="right">Right</button>
        </horizontal>
    </vertical>
    ...
    with tkml.Window(tkml=markup) as window:
        window.callbacks = {
