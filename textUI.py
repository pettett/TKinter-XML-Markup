...
<body minWidth=100 minHeight=200>
    <grid>
        ...
        <spinbox callback="SpinboxChanged" varname="SpinboxValue" gridy=5 gridx=1>option 1;option 2;option 3;option 4</spinbox>
        <p gridy=5 gridx=2 varname="SpinboxValue">spinbox</p>

        <p gridy=6>Slider</p>
        <slider orient=HORIZONTAL gridy=6 gridx=1 varname="slider" min=0 max=1 resolution=0.01f></slider>
