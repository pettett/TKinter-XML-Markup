...
<body minWidth="400" minHeight="100">
    <grid relief="sunken">
        ...
        <!-- <listbox gridx="2" gridy = "0">option 1;option 2;option 3</listbox> -->
        
        <button callback="OnButtonPress" gridy="1">Enter</button>
        ...
        <dropdown gridy="4" varname="spinbox" >Option 1;Option 2;Option 3</dropdown>
